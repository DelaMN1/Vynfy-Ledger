...
from app.utils.enums import AccountType, CategoryType
...
class CategoryForm(FlaskForm):
    ...
    type = SelectField(
        "Type",
        choices=[(CategoryType.REVENUE.value, "Revenue"), (CategoryType.EXPENSE.value, "Expense")],
...
class AccountForm(FlaskForm):
    ...
    type = SelectField(
        ...
        choices=[
            ...
            (AccountType.MOBILE_MONEY.value, "Mobile money"),
            (AccountType.WALLET.value, "Wallet"),
        ],
        validators=[DataRequired()],
    )
